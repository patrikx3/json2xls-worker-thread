...
---
# 📈 Convert JSON to Excel XLSX with offloading the constructing the data using a worker thread v2020.4.136
...
[**P3X-JSON2XLS-WORKER-THREAD**](https://pages.corifeus.com/json2xls-worker-thread) Build v2020.4.136
